...
<div class="container px-4 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-5">
            <h4 class="heading">Welcom Admin</h4>
        </div>
        <div class="col-7">
            <div class="row text-right">
                <div class="col-4">
                 <a href="/showAccount"><h6 class="mt-2"><button type="submit">List user</button></h6></a>
                </div>
                <div class="col-4">
                   <a href="/productServlet"><h6 class="mt-2"><button type="submit">List Product</button></h6></a>
                </div>
                <div class="col-4">
                    <h6 class="mt-2"><a href="/LogOutServlet" type="button">Log Out</a></h6>
                </div>
            </div>
        </div>
    </div>
